...
export const translations: Record<Language, TranslationStrings> = {
  EN: {
    ...
    privacyPolicy: [
      ...
      { title: '9. Advertising and Data Shared with Meta', body: 'We use the Meta (Facebook) SDK to measure the performance of our advertising. For this purpose, the app may share app events \u2014 such as installs, app launches, and completed purchases (amount and currency) \u2014 together with your device\u2019s advertising identifier, with Meta Platforms, Inc. On iOS this happens only if you allow tracking when asked (App Tracking Transparency); if you decline, events are sent without the identifier. Face recognition data and your photos are never shared with Meta. You can withdraw consent at any time in your device settings (iOS: Settings \u2192 Privacy \u2192 Tracking; Android: delete or reset your advertising ID).' },
      { title: '10. Data Retention', body: 'We retain your data as long as necessary to provide services and meet legal requirements, typically no longer than 3 years after your last transaction.' },
      { title: '11. Your Rights', body: 'You have the right to access, correct, or delete your personal data. Contact us at official@memotile.com to exercise these rights.' },
      { title: '12. Cookies', body: 'Our website uses cookies to enhance your experience. You may disable cookies in your browser settings, though some features may be affected.' },
      { title: '13. Policy Changes', body: 'We may update this policy periodically. Significant changes will be communicated via email or a prominent notice on our website.' },
      { title: '14. Contact', body: 'For privacy inquiries, contact us at official@memotile.com or Line: @memotile.' },
      { title: '15. Consent', body: 'By using our services, you consent to the collection and use of your information as described in this Privacy Policy.' },
    ],
    ...
    ddFacebookTitle: 'If you signed up with social login (Google \u00b7 Apple)',
    ddFacebookBody: 'The same process applies if you signed up using a social login such as Google or Apple. All data MemoTile holds about you will be deleted. Your Google or Apple account itself is not affected.',
  ...
  TH: {
    ...
    privacyPolicy: [
      ...
      { title: '9. การโฆษณาและข้อมูลที่แชร์กับ Meta', body: 'เราใช้ Meta (Facebook) SDK เพื่อวัดผลการโฆษณาของเรา เพื่อการนี้ แอปอาจแชร์อีเวนต์การใช้งาน เช่น การติดตั้ง การเปิดแอป และการสั่งซื้อที่สำเร็จ (จำนวนเงินและสกุลเงิน) พร้อมตัวระบุโฆษณาของอุปกรณ์ของคุณ ให้แก่ Meta Platforms, Inc. บน iOS การแชร์นี้จะเกิดขึ้นเฉพาะเมื่อคุณอนุญาตการติดตามเมื่อระบบถาม (App Tracking Transparency) หากคุณปฏิเสธ อีเวนต์จะถูกส่งโดยไม่มีตัวระบุ ข้อมูลการจดจำใบหน้าและรูปภาพของคุณจะไม่ถูกแชร์กับ Meta คุณสามารถถอนความยินยอมได้ทุกเมื่อในการตั้งค่าอุปกรณ์ (iOS: การตั้งค่า \u2192 ความเป็นส่วนตัว \u2192 การติดตาม; Android: ลบหรือรีเซ็ตรหัสโฆษณา)' },
      { title: '10. ระยะเวลาการเก็บรักษาข้อมูล', body: 'เราเก็บรักษาข้อมูลของคุณตราบเท่าที่จำเป็นต่อการให้บริการ โดยปกติไม่เกิน 3 ปีนับจากธุรกรรมล่าสุด' },
      { title: '11. สิทธิ์ของเจ้าของข้อมูล', body: 'คุณมีสิทธิ์เข้าถึง แก้ไข หรือลบข้อมูลส่วนบุคคลของคุณ โปรดติดต่อเราได้ที่ official@memotile.com' },
      { title: '12. คุกกี้และเทคโนโลยีติดตาม', body: 'เว็บไซต์ของเราใช้คุกกี้เพื่อพัฒนาประสบการณ์การใช้งาน คุณสามารถปิดใช้งานคุกกี้ในการตั้งค่าเบราว์เซอร์ได้' },
      { title: '13. การเปลี่ยนแปลงนโยบาย', body: 'เราอาจอัปเดตนโยบายนี้เป็นครั้งคราว และจะแจ้งให้คุณทราบผ่านทางอีเมลหรือประกาศบนเว็บไซต์' },
      { title: '14. ข้อมูลติดต่อ', body: 'สำหรับคำถามด้านความเป็นส่วนตัว ติดต่อเราได้ที่ official@memotile.com หรือ Line: @memotile' },
      { title: '15. การยินยอม', body: 'การใช้บริการของเราถือว่าคุณยินยอมให้เรารวบรวมและใช้ข้อมูลตามที่ระบุในนโยบายความเป็นส่วนตัวนี้' },
    ],
    ...
    ddFacebookTitle: 'หากคุณสมัครด้วยโซเชียลล็อกอิน (Google \u00b7 Apple)',
    ddFacebookBody: 'ขั้นตอนเดียวกันนี้ใช้กับผู้ที่สมัครด้วยโซเชียลล็อกอิน เช่น Google หรือ Apple ข้อมูลทั้งหมดที่ MemoTile เก็บไว้เกี่ยวกับคุณจะถูกลบ ทั้งนี้ไม่มีผลต่อบัญชี Google หรือ Apple ของคุณ',
